...
import CardImage3 from "../assets/cards/card-3.png";
      ...
      <div className="container mx-auto flex flex-col lg:flex-row gap-x-[32px]">
        ...
        <div className="flex-1 flex gap-x-[15px] lg:gap-x-[32px] -mt-[38px] z-10 lg:-mt-[77px] mx-auto">
          ...
          >
            ...
            {/* card image */}
            <div>
              <img className="w-full" src={CardImage1} alt="plan" />
            </div>
          </div>
          ...
          >
            ...
            {/* card image */}
            <div>
              <img className="w-full" src={CardImage2} alt="plan" />
            </div>
          </div>
        </div>
        ...
        {/* card 3 */}
        <div
          className="flex-1 bg-white w-full max-w-[542px] mx-auto p-[14px] lg:p-[26px] mt-4 lg:-mt-[77px] z-10 shadow-2xl rounded-md flex justify-between items-start"
          data-aos="fade-up"
          data-aos-delay="800"
        >
          {/* card text */}
